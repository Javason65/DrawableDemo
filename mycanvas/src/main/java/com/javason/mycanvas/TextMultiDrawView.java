...
public class TextMultiDrawView extends View {
    ...
    public TextMultiDrawView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    @Override
    ...
    protected void onDraw(Canvas canvas) {
        ...
        System.out.println(mPaint.breakText(text,true,getWidth(),curWidth));
        canvas.drawText(text,0,index,0,100,mPaint);
        int oldIndex=index;
        index=mPaint.breakText(text,true,getWidth()-Utils.dp2px(100),curWidth);
